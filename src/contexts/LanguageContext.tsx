...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  step1Title: 'Take a clear photo of your crop using your phone or upload an existing image from your gallery. Ensure the affected area is visible for accurate analysis.',
    step1Desc: '',
  step2Title: 'Our advanced AI system will automatically analyze the uploaded image to detect any signs of disease, pest, or nutrient deficiency.',
    step2Desc: '',
  step3Title: 'Instantly receive a detailed report with the diagnosis, severity, and confidence level, along with actionable recommendations tailored to your crop.',
    step3Desc: '',
  step4Title: 'Follow the provided recommendations and treatment methods to protect and improve your crop health. You can also connect with vendors or access government schemes.',
    step4Desc: '',
  ...
  step1Title: 'अपने फोन से अपनी फसल का स्पष्ट फोटो लें या गैलरी से पहले से मौजूद छवि अपलोड करें। सटीक विश्लेषण के लिए प्रभावित क्षेत्र दिखाई देना चाहिए।',
    step1Desc: '',
  step2Title: 'हमारी उन्नत एआई प्रणाली अपलोड की गई छवि का स्वचालित रूप से विश्लेषण करेगी और किसी भी रोग, कीट या पोषक तत्व की कमी का पता लगाएगी।',
    step2Desc: '',
  step3Title: 'तुरंत आपको विस्तृत रिपोर्ट मिलेगी जिसमें निदान, गंभीरता और विश्वास स्तर के साथ आपकी फसल के लिए विशेष सिफारिशें होंगी।',
    step3Desc: '',
  step4Title: 'दी गई सिफारिशों और उपचार विधियों का पालन करें, अपनी फसल के स्वास्थ्य की रक्षा करें और सुधारें। आप विक्रेताओं से जुड़ सकते हैं या सरकारी योजनाओं का लाभ ले सकते हैं।',
    step4Desc: '',
  ...
  step1Title: 'તમારા ફોનથી તમારા પાકનો સ્પષ્ટ ફોટો લો અથવા ગેલેરીમાંથી પહેલેથી રહેલી છબી અપલોડ કરો. યોગ્ય વિશ્લેષણ માટે અસરગ્રસ્ત વિસ્તાર દેખાય તે જરૂરી છે.',
    step1Desc: '',
  step2Title: 'અમારી અદ્યતન એઆઈ સિસ્ટમ આપમેળે અપલોડ કરેલી છબીનું વિશ્લેષણ કરશે અને રોગ, જીવાત અથવા પોષક તત્વોની ઉણપ શોધશે.',
    step2Desc: '',
  step3Title: 'તરત જ તમને વિગતવાર રિપોર્ટ મળશે જેમાં નિદાન, ગંભીરતા અને વિશ્વાસસ્તર સાથે તમારા પાક માટે ખાસ ભલામણો મળશે.',
    step3Desc: '',
  step4Title: 'આપેલ ભલામણો અને સારવાર પદ્ધતિઓ અનુસરો, પાકના આરોગ્યને સુરક્ષિત અને સુધારો. તમે વધુ મદદ માટે ચેટ કરી શકો છો, વિક્રેતાઓ સાથે જોડાઈ શકો છો અથવા સરકારી યોજનાઓ મેળવી શકો છો.',
    step4Desc: '',
