...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  howToTitle: 'कैसे उपयोग करें - किसानों के लिए सरल चरण',
    ...
    step1Desc: '📱',
    step2Title: 'चरण 2: हमारी उन्नत AI प्रणाली अपलोड की गई छवि का स्वचालित रूप से विश्लेषण करेगी और किसी भी रोग, कीट या पोषक तत्व की कमी का पता लगाएगी।',
    step2Desc: '🤖',
    ...
    step3Desc: '💬',
    step4Title: 'चरण 4: दी गई सिफारिशों और उपचार विधियों का पालन करें, अपनी फसल के स्वास्थ्य की रक्षा करें और सुधारें। आप अधिक मदद के लिए चैट कर सकते हैं, विक्रेताओं से जुड़ सकते हैं या सरकारी योजनाओं का लाभ ले सकते हैं।',
    step4Desc: '',
  ...
  howToTitle: 'કેવી રીતે વાપરવું - ખેડૂતો માટે સરળ પગલાં',
    step1Title: 'પગલું 1: તમારા પાકનો સ્પષ્ટ ફોટો લો અથવા ગેલેરીમાંથી પહેલેથી રહેલી છબી અપલોડ કરો. ખાતરી કરો કે અસરગ્રસ્ત વિસ્તાર દેખાય છે જેથી વિશ્લેષણ યોગ્ય રીતે થઈ શકે.',
    step1Desc: '📱',
    step2Title: 'પગલું 2: અમારી અદ્યતન AI સિસ્ટમ આપમેળે અપલોડ કરેલી છબીનું વિશ્લેષણ કરશે અને રોગ, જીવાત અથવા પોષક તત્વોની ઉણપ શોધશે.',
    step2Desc: '🤖',
    ...
    step3Desc: '💬',
    step4Title: 'પગલું 4: આપેલ ભલામણો અને સારવાર પદ્ધતિઓ અનુસરો, પાકના આરોગ્યને સુરક્ષિત અને સુધારો. વધુ મદદ માટે ચેટ કરો, વિક્રેતાઓ સાથે જોડાઓ અથવા સરકારી યોજનાઓ મેળવો.',
    step4Desc: '',
