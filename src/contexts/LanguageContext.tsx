...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  howToTitle: 'कैसे उपयोग करें - किसानों के लिए सरल चरण',
    ...
    step3Desc: '',
    step4Title: 'चरण 4: दी गई सिफारिशों और उपचार विधियों का पालन करें, अपनी फसल के स्वास्थ्य की रक्षा करें और सुधारें। अधिक मदद के लिए चैट करें, विक्रेताओं से जुड़ें या सरकारी योजनाओं का लाभ लें।',
    step4Desc: '',
